...
const DemoComputer = (props) => {
  const group = useRef();
  const { nodes, materials } = useGLTF(assets.models.computer);

  const txt = useVideoTexture(props.texture ? props.texture : assets.projects.videos.demoFallback);
  const screenTexture = useMemo(() => {
    const texture = txt.clone();
    texture.flipY = false;
    return texture;
  }, [txt]);
...
useGLTF.preload(assets.models.computer);
